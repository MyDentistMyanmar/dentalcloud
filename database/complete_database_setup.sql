...
BEGIN
  ...
  IF COALESCE(v_patient.balance, 0) <= 0 THEN RAISE EXCEPTION 'Patient has no outstanding balance'; END IF;
  ...
  INSERT INTO payments (
    ...
    p_created_by_user_id, NULLIF(BTRIM(COALESCE(p_created_by_user_name, '')), '')
  )
