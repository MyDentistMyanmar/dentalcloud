...
CREATE TABLE doctors (
  ...
  commission_per_visit DECIMAL(12,2) NOT NULL DEFAULT 0,
...
ALTER TABLE doctors ADD CONSTRAINT doctors_commission_type_check CHECK (commission_type IN ('percentage', 'flat_visit'));
